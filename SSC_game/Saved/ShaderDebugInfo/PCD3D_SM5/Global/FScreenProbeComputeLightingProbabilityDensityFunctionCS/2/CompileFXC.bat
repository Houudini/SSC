...
%FXC% LumenScreenProbeImportanceSampling.usf /E ScreenProbeComputeLightingProbabilityDensityFunctionCS /Zpr /Gec /O3 /T cs_5_0 /Ni /FcLumenScreenProbeImportanceSampling.d3dasm 
 pause
:END
REM
