...
%FXC% LumenSceneDirectLightingSoftwareRayTracing.usf /E LumenSceneDirectLightingTraceDistanceFieldShadowsCS /Zpr /Gec /O3 /T cs_5_0 /Ni /FcLumenSceneDirectLightingSoftwareRayTracing.d3dasm 
 pause
:END
REM
