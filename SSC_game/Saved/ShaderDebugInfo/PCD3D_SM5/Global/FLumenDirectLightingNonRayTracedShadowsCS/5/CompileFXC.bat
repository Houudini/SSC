...
%FXC% LumenSceneDirectLightingShadowMask.usf /E LumenSceneDirectLightingNonRayTracedShadowsCS /Zpr /Gec /O3 /T cs_5_0 /Ni /FcLumenSceneDirectLightingShadowMask.d3dasm 
 pause
:END
REM
