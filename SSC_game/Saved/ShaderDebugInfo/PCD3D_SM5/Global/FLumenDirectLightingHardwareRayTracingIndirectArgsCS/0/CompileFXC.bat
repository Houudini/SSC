...
%FXC% LumenSceneDirectLightingHardwareRayTracing.usf /E LumenDirectLightingHardwareRayTracingIndirectArgsCS /Zpr /Gec /O3 /T cs_5_0 /Ni /FcLumenSceneDirectLightingHardwareRayTracing.d3dasm 
 pause
:END
REM
